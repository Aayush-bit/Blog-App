...
const PostCardEditDelete = ({post, authorId, author}) => {
    ...
    return (
        <div className="container postCardEditDelete">
            <Container>
                <Row>
                    <Col sm={8} className="postCardEditDelete__title">
                        <h3>{showBrief(post.post.title, 50)}</h3>
                    </Col>
                    ...
                    <Col sm={4} className="postCardEditDelete__actions">
                        ...
                        <div className="postCardEditDelete__action postCardEditDelete__actions__edit">
                        ...
                        <div className="postCardEditDelete__action postCardEditDelete__actions__delete">
            ...
            {/* <div className="postCardEditDelete__box">
                <div className="postCardEditDelete__content">
                    <div className="postCardEditDelete__title">
                        {showBrief(post.post.title, 50)}
                    </div>
                    <div className="postCardEditDelete__author text-muted text-capitalize">
                        <small>by- {author}</small>
                    </div>
                ...
                <div className="postCardEditDelete__actions">
                ...
                <div className="postCardEditDelete__info">
                    <div className="postCardEditDelete__date-time text-muted">
                        {
                            post.editedOn ? 
                            post.editedOn.split("T")[0] + " (edited)": 
